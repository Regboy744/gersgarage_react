...
export default class AddressEditInfo extends Component {
     constructor(props) {
          super(props);
     ...
     handleRegister(e) {
          ...
          if (this.checkBtn.context._errors.length === 0) {
               UserService.patchAddress(this.state.address_type, this.state.street, this.state.city, this.state.code, this.state.area).then(
                    (response) => {
                         this.setState({
