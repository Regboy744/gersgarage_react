...
class EditParts extends Component {
     ...
     componentDidMount() {
          axios.get("https://gersgarage-api.herokuapp.com/stock/" + this.props.match.params.id)
               .then((response) => {
                    this.setState({
          ...
          return (
               <div>
                    ...
                    <form onSubmit={this.onSubmit}>
                         ...
                         <div className="form-group">
                              <input type="submit" value="Edit Part Log" className="btn btn-primary" />
                         </div>
                    </form>
               </div>
          );
